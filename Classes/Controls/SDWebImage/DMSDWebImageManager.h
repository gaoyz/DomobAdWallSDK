...
#import "DMSDWebImageDownloaderDelegate.h"
#import "DMSDWebImageManagerDelegate.h"
#import "DMSDImageCacheDelegate.h"
 ...
 *                   failure:nil];
 */
@interface DMSDWebImageManager : NSObject <DMSDWebImageDownloaderDelegate, DMSDImageCacheDelegate>
{
 ...
 */
- (void)downloadWithURL:(NSURL *)url delegate:(id<DMSDWebImageManagerDelegate>)delegate options:(SDWebImageOptions)options userInfo:(NSDictionary *)info;

// use options:SDWebImageRetryFailed instead
- (void)downloadWithURL:(NSURL *)url delegate:(id<DMSDWebImageManagerDelegate>)delegate retryFailed:(BOOL)retryFailed __attribute__ ((deprecated));
// use options:SDWebImageRetryFailed|SDWebImageLowPriority instead
- (void)downloadWithURL:(NSURL *)url delegate:(id<DMSDWebImageManagerDelegate>)delegate retryFailed:(BOOL)retryFailed lowPriority:(BOOL)lowPriority __attribute__ ((deprecated));
