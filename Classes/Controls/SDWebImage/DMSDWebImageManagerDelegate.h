...
@class DMSDWebImageManager;
@class UIImage;

/**
 * Delegate protocol for SDWebImageManager
 */
@protocol DMSDWebImageManagerDelegate <NSObject>
 ...
 */
- (void)webImageManager:(DMSDWebImageManager *)imageManager didProgressWithPartialImage:(UIImage *)image forURL:(NSURL *)url userInfo:(NSDictionary *)info;
 ...
 * @param info The user info dictionnary
 */
- (void)webImageManager:(DMSDWebImageManager *)imageManager didFinishWithImage:(UIImage *)image forURL:(NSURL *)url userInfo:(NSDictionary *)info;
- (void)webImageManager:(DMSDWebImageManager *)imageManager didFinishWithImage:(UIImage *)image forURL:(NSURL *)url;
 ...
 * @param info The user info dictionnary
 */
- (void)webImageManager:(DMSDWebImageManager *)imageManager didFailWithError:(NSError *)error forURL:(NSURL *)url userInfo:(NSDictionary *)info;
- (void)webImageManager:(DMSDWebImageManager *)imageManager didFailWithError:(NSError *)error forURL:(NSURL *)url;
