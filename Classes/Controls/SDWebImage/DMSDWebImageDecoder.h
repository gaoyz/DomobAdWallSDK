...
@protocol DMSDWebImageDecoderDelegate;
...
@interface DMSDWebImageDecoder : NSObject
{
 ...
 */
@protocol DMSDWebImageDecoderDelegate <NSObject>
 ...
 */
- (void)imageDecoder:(DMSDWebImageDecoder *)decoder didFinishDecodingImage:(UIImage *)image userInfo:(NSDictionary *)userInfo;
