...
extern NSString *const DMSDWebImageDownloadStartNotification;
extern NSString *const DMSDWebImageDownloadStopNotification;

/**
 * Asynchronous downloader dedicated and optimized for image loading.
 */
@interface DMSDWebImageDownloader : NSObject
{
    @private
    NSURL *url;
    DMSDWIWeak id<DMSDWebImageDownloaderDelegate> delegate;
...
@property (nonatomic, assign) id<DMSDWebImageDownloaderDelegate> delegate;
